...
namespace Rinsen.DatabaseInstaller
{
    internal class AdoNetVersionStorage : IVersionStorage
    {
        ...
        public async Task CreateAsync(InstallationNameAndVersion installedNameAndVersion, SqlConnection connection, SqlTransaction transaction)
        {
        ...
        public async Task<IEnumerable<InstallationNameAndVersion>> GetAllAsync(SqlConnection connection, SqlTransaction transaction)
        {
        ...
        public async Task<bool> IsInstalledAsync(SqlConnection connection)
        {
        ...
        public async Task<bool> IsInstalledAsync(SqlConnection connection, SqlTransaction sqlTransaction)
        {
        ...
        public async Task<int> StartInstallationAsync(InstallationNameAndVersion installedVersion, SqlConnection connection, SqlTransaction transaction)
        {
        ...
        public async Task<int> EndInstallationAsync(InstallationNameAndVersion installedVersion, SqlConnection connection, SqlTransaction transaction)
        {
